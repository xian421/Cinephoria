...
<script>
    ...
    async function loadProfile() {
        ...
        try {
            ...
            profileStore.set(data); // Setze die Profildaten im Store
    ...
    function handleProfileUpdate(event) {
        const { vorname, nachname, email, nickname, role } = event.detail;
        profileStore.update(current => ({
            ...current,
            vorname,
            nachname,
...
<div class="background">
    <header class="header-section">
        ...
        <p class="tagline">Verwalte deine Daten!</p>
    </header>
