...
<script>
  ...
  // Druckfunktion: Öffnet den Browser-Druckdialog
  function printReceipt() {
    window.print();
  }

  // Dynamische Validierung des Rabatts
...
/* Hier wird definiert, was im Druckmodus passieren soll */
@media print {
  /* Alle Elemente ausblenden */
  body * {
    visibility: hidden;
  }
  /* Nur den Quittungsbereich einblenden */
  .receipt, .receipt * {
    visibility: visible;
  }
  /* Positioniere den Quittungsbereich oben links */
  .receipt {
    position: absolute;
    left: 0;
    top: 0;
  ...
  /* Alternativ kannst du auch die übrigen Klassen ausblenden */
